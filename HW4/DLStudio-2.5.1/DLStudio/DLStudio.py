...
CHANGE LOG:
  ...
  Version 2.5.0:
    ...
    problem in Version 2.5.0.  An additional feature of the new version is the
    addition of a transformer based Autoencoder class to the code. My plan is to use
    this class for future extensions of the code with variational and
...
@tag2_vae
    ...
    low-dimensional (relatively speaking) vector $z$ that can be modeled with a
    simple probabilty distribution (which, ideally speaking, would be a zero-mean,
    unit-covariance Gaussian) that could subseqently be used to generate useful
    variants of the input image.

    A great thing about variational autoencoding is that it allows to carry out
    what's known as disentanglement learning in which the latent space captures what
    you believe is the essence in each image and have the other parts of your overall
    neural architecture capture the rest.  Subsequently, you can use the Decoder in
    the VAE to transform the essence in whichever way you want while you carry
    through the rest unchanged for the production of the final output.
...
@tag2_diffusion
    ...
    At each timestep in the forward q-chain, the data coursing through the chain
    is subject to a Markov transition that injects a small amount of zero-mean and
...
@tag2_transformers
    ...
    You will see four different implementations of the transformer architecture in
    ...
    Finally, if you wish to play with transformer-based autoencoding in DLStudio,
    start with the following script:

          run_autoencoder_with_transformer.py

    The script is also uses the CIFAR10 dataset.
...
THE MAIN INNER CLASSES OF THE DLStudio CLASS:
    ...
    (11) class TextClassificationWithEmbeddings
...
Examples DIRECTORY:
    ...
    (14) text_classification_with_TEXTnet.py
    ...
    (15) text_classification_with_TEXTnet_word2vec.py
    ...
    (16) text_classification_with_TEXTnetOrder2.py
    ...
    (17) text_classification_with_TEXTnetOrder2_word2vec.py
    ...
    (18) text_classification_with_GRU.py
    ...
    (19) text_classification_with_GRU_word2vec.py
